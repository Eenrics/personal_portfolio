             ...
             <div className=''>
              <svg  className='h-9'
                    ...
                    text-rendering="geometricPrecision">
                      <defs><linearGradient id="ePBXlpJ48592-fill" x1="0" y1="0.5" x2="1" y2="0.5" spreadMethod="pad" gradientUnits="objectBoundingBox" gradientTransform="translate(0 0)"><stop id="ePBXlpJ48592-fill-0" offset="0%" stop-color="#fff"/><stop id="ePBXlpJ48592-fill-1" offset="100%" stop-color="#f4f4f4"/></linearGradient></defs>
